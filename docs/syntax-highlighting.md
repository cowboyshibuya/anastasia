...
Desktop syntax highlighting lives in the pure `anastasia-syntax` crate. It detects
...
5. Run `cargo test -p anastasia-syntax`, UI Markdown/Changes tests, the ignored
