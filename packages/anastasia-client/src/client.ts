...
export interface AnastasiaClientOptions {
...
export type WakuClientOptions = AnastasiaClientOptions;

export class AnastasiaRpcError extends Error {
  constructor(message: string) {
    super(message);
    this.name = "AnastasiaRpcError";
  }
}

export const WakuRpcError = AnastasiaRpcError;
...
/** Browser-safe client for Anastasia's versioned JSON-over-WebSocket protocol. */
export class AnastasiaClient {
...
export type WakuClient = AnastasiaClient;
export const WakuClient = AnastasiaClient;
