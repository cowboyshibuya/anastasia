/**
 * The /auth/* HTTP surface absorbed from anastasia's apps/server:
 *
 ...
 * for the user to paste into the device that started the flow (`anastasia login`),
