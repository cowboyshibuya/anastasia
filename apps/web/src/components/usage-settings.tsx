...
import { ProviderIcon, AnastasiaIcon } from '@/components/anastasia-icon'
  ...
  return (
    <div className="mt-1.5 flex min-h-0 flex-col">
      <div className="flex min-h-8 flex-wrap items-center gap-2.5">
        ...
        >
          <AnastasiaIcon className={cn('size-3', usage.isFetching && 'motion-safe:animate-spin')} name={usage.isFetching ? 'loaderCircle' : 'rotateCw'} />
        </button>
      </div>
