...
final class DemoDataset {
    ...
    static func standard() -> DemoDataset {
        ...
        let anastasia = Space(id: "space-anastasia", deviceId: "dev-mac",
                          path: "/Users/dev/anastasia", name: nil, gitDetected: true,
        ...
        let chats = [
            Chat(id: "chat-veil", deviceId: "dev-mac", title: "Streaming veil on transcript rows",
                 archived: false, cwd: "/Users/dev/.anastasia/worktrees/anastasia-veil-fade",
            ...
            Chat(id: "chat-tabs", deviceId: "dev-mac", title: "Tool group header colors",
                 ...
                 spaceId: anastasia.id, lastSeenAt: now - 3_600_000),
        ...
        return DemoDataset(devices: [mac, vps], spaces: [anastasia, edge],
    ...
    static let fileTree: [String: [String]] = [
        ...
        "/Users/dev/Projects": ["anastasia", "dotfiles", "blog", "playground"],
        "/Users/dev/Projects/anastasia": ["apps", "crates", "docs", "edge"],
    ...
    private static let repoNames: Set<String> = ["anastasia", "dotfiles", "blog", "playground", "edge", "landing"]
    ...
    func listRefs(spacePath: String) -> [RepoRef] {
        ...
        let seeded: [RepoRef]
        if spacePath.contains("anastasia") {
            seeded = [
                RepoRef(name: "main", current: true, worktreePath: nil),
                RepoRef(name: "veil-fade", current: false,
                        worktreePath: "/Users/dev/.anastasia/worktrees/anastasia-veil-fade"),
    ...
    func createWorktree(spacePath: String, base: String) -> String {
        ...
        let path = "/Users/dev/.anastasia/worktrees/\((spacePath as NSString).lastPathComponent)-\(slug)"
        ...
        case "chat-veil":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "editFile", fields: ["path": "Anastasia/Transcript/Veil.swift"]), isError: false, resolved: true),
                    .tool(id: "tool3", call: RenderToolCall(tag: "exec", fields: ["command": "xcodebuild -scheme Anastasia build"]), isError: false, resolved: true),
                    .text(id: "t1", text: """
        ...
        case "chat-tabs":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "exec", fields: ["command": "cargo test -p anastasia-ui tool_group"]), isError: true, resolved: true),
