...
/// anastasia-proto FolderListing (entities.rs:225): the device's answer to
...
/// anastasia-proto RepoRef (entities.rs:193): one selectable ref from ListRefs.
...
/// anastasia-proto RunRequest (agent.rs:81). `reasoning` is lowercase
