...
impl Waku {
            ...
            let history = cx
                ...
                .spawn(async move {
                    match daemon.request(
                        Uuid::nil(),
                        Uuid::nil(),
                        anastasia_client::Command::LoadUsageHistory {
                            window,
                            project_roots,
                        },
                    )? {
                        anastasia_client::ResponsePayload::UsageHistory { history } => Ok(history),
    ...
    /// Display name and path caption for a project row: a known Anastasia
