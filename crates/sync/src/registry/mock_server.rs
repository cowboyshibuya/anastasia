...
//! (`anastasia_doc::apply_op`). Test infrastructure only (`mock-server` feature):
//! anastasia-sync's client tests and anastasia-engine's two-engine integration tests
...
use anastasia_doc::{RegistryRow, RowOp, apply_op};
