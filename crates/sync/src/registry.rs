...
//! [`anastasia_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use anastasia_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
...
// ── stats (RoomStatsSnapshot-compatible so SyncStatus/`anastasia sync` render it) ─
