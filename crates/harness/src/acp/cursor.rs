...
//!
//! Anastasia opts into parameterized mode. Auto's Intelligence / Balance / Cost
...
use anastasia_proto::{Model, ModelOption, ModelOptionChoice, ReasoningLevel};
...
/// Anastasia can render — so callers put it on the description subline (or fold
...
/// Rewrite the wire model list into Anastasia's picker shape.
...
/// Preference-ordered effort tokens for a Anastasia reasoning pick, used when
