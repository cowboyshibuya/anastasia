...
//!
//! This crate intentionally depends only on [`anastasia_protocol`], so GUI and CLI
...
pub use anastasia_protocol::*;
pub use workspace_client::WorkspaceClient;

pub mod git_branch {
    pub use anastasia_protocol::git::{BranchEntry, BranchSnapshot};
}

pub mod git_commit {
    pub use anastasia_protocol::git::AgentInvocation;
    pub use anastasia_protocol::git::CommitSnapshot as Snapshot;
}

pub mod worktree {
    pub use anastasia_protocol::git::CreatedWorktree;
}
