...
use anastasia_proto::WorkspaceScope;
...
/// Human platform label (anastasia settings.devices.tsx `platformLabel`).
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let rows: Vec<AnyElement> = devices
            ...
            .map(|(ix, device)| {
                ...
                // tone so it "cuts" the tile — anastasia settings.devices.tsx
                ...
                // "Added {time ago}" — always present (anastasia settings.devices.tsx).
                ...
                widgets::card_row(&theme, ix == 0)
                    ...
                    .child(
                        // `opacity-70 hover:opacity-100` (anastasia: also rises on
