...
//! of [`anastasia_sync::chat_client::ChatDocSink`] and
//! [`anastasia_sync::chat_client::CheckpointFetcher`], binding a
...
use anastasia_doc::SessionDoc;
use anastasia_sync::chat_client::{ChatDocSink, CheckpointFetcher};
use anastasia_sync::{DocsStore, SyncError};
