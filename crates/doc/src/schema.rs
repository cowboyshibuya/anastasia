...
///
/// Port of anastasia's `DocSegmentWriter` diff discipline: called with the *folded* parts of the
...
mod tests {
    ...
    use anastasia_proto::{AgentEvent, ToolCall};
    ...
    fn segment_writer_round_trips_stripped_tool_fields() {
        ...
        fold_event_into_parts(
            ...
            &AgentEvent::ToolResult {
                ...
                is_error: false,
                output: Some("total 0\nmore lines".into()),
                diff: Some(anastasia_proto::ToolDiff {
                    path: "/w/a.rs".into(),
                    old_text: Some("old\n".into()),
                    new_text: "new\n".into(),
                }),
