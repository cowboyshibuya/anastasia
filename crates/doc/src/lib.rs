//! anastasia-doc — session & workspace Loro doc schemas and the typed mirror layer.
//!
//! Port of anastasia's `packages/session-doc`. The schema SHAPE (container names, part maps with
...
//!
//! Load-bearing invariant (measured in anastasia, `oplog-shape.test.ts`): message parts are a
