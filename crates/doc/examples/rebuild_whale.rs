...
//! Usage: cargo run -p anastasia-doc --example rebuild_whale -- <snapshot.bin>
use anastasia_doc::rebuild::{doc_epoch, rebuild_thin_doc};
use anastasia_doc::schema::SessionDoc;
use loro::LoroDoc;
